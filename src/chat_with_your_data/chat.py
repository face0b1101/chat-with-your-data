...
from chat_with_your_data.shared import initialize_session_state
...
def build_response():
    ...
    try:
        parsed_response = {
            ...
            for line in full_response["choices"][0]["message"]["content"].split("\n\n")
        }
...
if prompt := st.chat_input("What is up?"):
    prompted_content = build_prompt("default", {"query": prompt})
    ...
    extras = [
        {"type": "Full Prompt", "body": prompted_content},
        {"type": "Full Response", "body": parsedResponse},
    ]
    st.session_state.messages.append(
        {"role": "assistant", "content": response, "extras": extras}
    )
    ...
    if parsedResponse["TOOL"] == "query":
        ...
        extras = [
            {"type": "Full Prompt", "body": promptedContent},
            {"type": "Full Response", "body": parsedResponse},
        ]
        ...
        promptedContent = build_prompt(
            "interpret", {"query": prompt, "results": esResponse}
        )
        ...
        extras = [
            {"type": "Full Prompt", "body": promptedContent},
            {"type": "Full Response", "body": parsedResponse},
            {"type": "Query Results", "body": esResponse},
        ]
